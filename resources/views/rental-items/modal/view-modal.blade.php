            ...
            <div class="p-5 bg-white border border-gray-200 rounded-b-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <dl class="max-w-md mx-auto space-y-4 text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                    <div class="flex flex-col pt-3">
                        ...
                        <dd class="text-lg font-semibold break-words" data-field="name"></dd>
                    </div>
                    <div class="flex flex-col pt-3">
                        <dt class="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Status</dt>
                        <dd class="text-lg font-semibold break-words" data-field="status"></dd>
                    </div>
                    <div class="flex flex-col pt-3">
                        <dt class="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Descrição</dt>
                        <dd class="text-lg font-semibold break-words" data-field="description"></dd>
                    </div>
                    <div class="flex flex-col pt-3">
                        <dt class="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Preço por hora</dt>
                        <dd class="text-lg font-semibold break-words" data-field="price_per_hour"></dd>
                    </div>
                    <div class="flex flex-col pt-3">
                        <dt class="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Preço por dia</dt>
                        <dd class="text-lg font-semibold break-words" data-field="price_per_day"></dd>
                    </div>
                    <div class="flex flex-col pt-3">
                        <dt class="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Preço por mês</dt>
                        <dd class="text-lg font-semibold break-words" data-field="price_per_month"></dd>
                    </div>
                    <div class="flex flex-col pt-3">
